package cybersoft.javabackend.java16giravanthai.role.controller;
...
import cybersoft.javabackend.java16giravanthai.role.service.GiraRoleService;
...
public class GiraRoleController {
	...
	@PostMapping
	public Object createNewRole(@Valid @RequestBody GiraRoleDto dto,BindingResult bind) {
		
		if (bind.hasErrors()){
			return new ResponseEntity<>(bind.getAllErrors()
